...
class BaseTrainer:
    ...
    def _setup_train(self, world_size):
        ...
        if self.pruner is None:
            ...
            pruned_macs, pruned_nparams = tp.utils.count_ops_and_params(self.model, example_inputs)
            print(f"Before pruning iter : MACs={pruned_macs / 1e9} G, #Params={pruned_nparams / 1e6} M, ")
            ignored_layers = []
